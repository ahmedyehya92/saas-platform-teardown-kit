# <Product Name> — Platform Teardown
...
One paragraph: what the product does, who it's for, and its category peers.
...
3–5 bullets: the things a reader most needs to know, including any notable
gap between marketing claims and observed reality.

## Confidence & gaps

What could not be verified, and why (paywall, no public API, no reviewer
access, etc.) — be explicit rather than silent about limitations.
